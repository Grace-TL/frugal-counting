...
public class SimpleBitwiseArray extends AuxilaryBitSet {
	...
	{
		bucketStart += idx*this.itemSize;
		return super.getBits(bucketStart, bucketStart + this.itemSize);
...
//		int end = bucketStart+this.bucketBitSize -(maxToShift+1)*this.itemSize;
